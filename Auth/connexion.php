...
<body>
  ...
  <div class="classContainerFormConnexion">
    ...
    <form action="" method="post">
      ...
      <p><a href="forgot_password.php">Mot de passe oublié?</a></p><br>
    ...
    <?php }else{?>
      <form action="" method="post">
        ...
        <div class="classTextConnexion">
          <p style="margin-left:1em;"><a href="forgot_password.php">Mot de passe oublié?</a></p><br>
          <p style="margin-left:1em;">Pas de compte ? <a href="../index.php">Inscrivez-vous</a> </p>
        </div>
      </form>
    <?php }?>
